				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li><a href="incident.aspx">Recent Incident</a></li>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner desc">
                               ...
                               <h3 class="heading-section">We are available for you 24*7</h3>
			...
			<div class="row">
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						...
						<ul>
							<li class="address">Chandigarh University <br></li>
							<li class="phone"><a href="tel://12345670820">+ 1235 2355 98</a></li>
							<li class="email"><a href="mailto:info@you.com">dhruvkinger813@gmail.com</a></li>
							<li class="url"><a href="http://gettemplates.co">firexpert1.co</a></li>
						</ul>
					</div>
